#!/usr/bin/env fsharpi
#load "./src/Amqp091Parser/Pervasives.fs"
...
let genClass (m: GenClass) =
    [ yield sprintf "module Amqp091Parser.%s" (Casing.pascal m.Name)
      yield "open Amqp091Parser.Amqp"
      yield "\r\n"
...
|> List.iter (fun c -> 
    let text = genClass c
    System.IO.File.WriteAllText(__SOURCE_DIRECTORY__ </> "./src/Amqp091Parser/" </> "Gen" + Casing.pascal c.Name + ".fs", text))
